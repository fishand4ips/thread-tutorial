package com.alexander.komegunov.semaphore;

import java.util.concurrent.Semaphore;

/**
 * Задача: Есть несколько философов, допустим, пять, но одновременно
 * за столом могут сидеть не более двух. И надо, чтобы все философы
 * пообедали, но при этом не возникло взаимоблокировки философами
 * друг друга в борьбе за тарелку и вилку.
 */

public class ProgramSemaphorePhilosopher {
